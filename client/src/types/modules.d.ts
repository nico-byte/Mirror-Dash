...
declare module 'socket.io-client' {
    interface Socket {
        ...
        emit(
            event: 'createLobby',
            data: { lobbyName: string; playerName: string },
        ...
        on(
            event: 'playerLeftLobby',
            listener: (data: { playerId: string; playerName: string }) => void
        ): this;
        on(
        ...
        on(
            event: 'levelChanged',
            listener: (data: { playerId: string; levelId: string; lobbyId: string }) => void
        ): this;
        on(
            event: 'forceLevelChanged',
            listener: (data: {
                levelId: string;
                initiatorId: string;
                initiatorName: string;
        ...
        on(
            event: 'timerSync',
            listener: (data: { timeLeft: number; isPenalty?: boolean }) => void
        ): this;
